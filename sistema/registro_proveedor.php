...
<body>
	...
	<section id="container">
		...
		<div class="form_register">
            <h1><i class="fa fa-building" aria-hidden="true"></i> Registro Proveedor</h1>
            <hr>
            ...
            <form action="" method="post">
                ...
                <button type="submit" class="btn_save"><i class="fa fa-save" aria-hidden="true"></i> Guardar Proveedor</button>
            </form>
