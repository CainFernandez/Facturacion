<?php
    ...
    if(!empty($_POST)){
        ...
        //-------------- NUEVA VENTA LLAMANDO A 'BD' ------------------//
                    ...
                    if($result > 0){
                        ...
                        while($data = mysqli_fetch_assoc($query_detalle_temp)){
                            ...
                            $detalleTabla .= '<tr>
                                                ...
                                                <td class="">
                                                <a href="#" class="link_delete" onclick="event.preventDefault(); del_product_detalle('.$data['correlativo'].');">
            ...
            //LLamando a BD para eliminar producto con el procedimiento almacenado.
            ...
            //Accion procesarVenta para venta.
        ...
        //--------- LISTA DE VENTAS LLAMANDO A 'BD' -----------------//
            //Info Factura mostrar datos.
            ...
            if($_POST['action'] == 'changePassword'){
                ...
                if(!empty($_POST['passActual']) && !empty($_POST['passNuevo']))
                {
                    ...
                    if($result > 0)
                    {
                        ...
                        $code = '1';
                        $msg  = "La contraseña actual es incorrecto.";
                    }
