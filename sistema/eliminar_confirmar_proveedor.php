...
<body>
	...
	<section id="container">
		<div class="data_delete">
            <i class="fa fa-building fa-7x" aria-hidden="true" style="color: #e66262"></i>
			<br>
			<br>
			...
			<form method="post" action="" >
				...
				<a href="lista_proveedor.php" class="btn_cancel"><i class="fa fa-ban" aria-hidden="true"></i> Cancelar</a>
